...
enum COMMAND_FACTORYTEST 
{
    ...
    FAC_ID_RING_PLAY_START          = 0x1A,

    FAC_ID_LED_ON                   = 0x1B,
    FAC_ID_LED_OFF                  = 0x1C,

    FAC_ID_IR_SENSOR                = 0x1D,
    FAC_ID_ULTRASONIC_SENSOR        = 0x1E,
    ...
    FAC_ID_SET_ROBOT_GENDER         = 0x2E,
    FAC_ID_GET_ROBOT_GENDER         = 0x2F,

    FAC_ID_CAMERA_IMG_COMPARE       = 0x30,

    FAC_ID_SET_POWER_MODE           = 0x31,
    FAC_ID_GET_ROBOT_CHECK_CLOUD_SN = 0x32,
    FAC_ID_RING_PLAY_STOP           = 0x33,

    FAC_ID_MOTOR_CALIBRATION        = 0x34,
    FAC_ID_MOTOR_MOVE               = 0x35,

    FAC_ID_MIC_TEST                 = 0x36,
    FAC_ID_CAMERA_PREVIEW           = 0x37,
    FAC_ID_MOTOR_STOP               = 0x38,
};
